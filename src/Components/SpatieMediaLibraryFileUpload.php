...
class SpatieMediaLibraryFileUpload extends FileUpload
{
    ...
    protected function setUp(): void
    {
        ...
        // Media Library handles relationship persistence.
        ...
        // Note: Filament v4 passes only "file" to this callback.
        $this->saveUploadedFileUsing(static function (SpatieMediaLibraryFileUpload $component, TemporaryUploadedFile $file): ?string {
            /** @var ?Model $record */
            ...
            $mediaAdder = $record->addMediaFromString($binary);
